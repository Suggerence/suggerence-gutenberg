...
export const BlockEditorStateLoader = () =>
{
    ...
    return (
        <div className="absolute bottom-4 right-4 bg-block-generation-background border border-block-generation-border rounded-lg flex flex-col items-center gap-4 text-block-generation-primary">
            <div className="pt-4">
                <BlockEditorLoaderFeedbackIcon />
            </div>

            <div className="bg-block-generation-secondary dark:bg-block-generation-popover p-4 rounded-b-lg">
